...
//Edited by @Hungryfoxz....

//Copy paste in your favourite IDE to implement code....
//There may be some error ,Not fully tested yet...
//The deleteElement funtion not workig as intended...I will update it when i find some time....
//If you can correct it on yourself ,please share..on my #GroupB_JIST group..
//Thanks..
//Start copying from the below line...
...
int main()
{
    int option, val;    //option variable for user input option...
    struct node* ptr;
    create_tree(tree);
    do
    {
