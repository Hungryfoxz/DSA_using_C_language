...
//[+]Edited with sublime text..
//[+]Compiled with VisualStudioCode..
//[+]Code edited by @KaustavKumarKhanikar..
//[+]Copy from the next line..

#include<stdio.h>
#include<stdlib.h>
typedef enum { FALSE ,TRUE } boo1;

//Creation of Structure with tag node...
struct node
{
	int val;
	int balance;
...
void main()
/*......code-edit from Kaustav Kumar Khanikar....please remove this line while compilation*/
{
	boo1 ht_inc;
	int data;
	int option;
